...
with tf.Session() as sess:
    ...
    for len_num in range(1,51):
        ...
        print("code length="+str(len_num)+"       "+str(count))
        if count != 0:
            ...
            result_df = result_df.append(pd.DataFrame({'code行数':[len_num],'正样本pre':[label2_dict['precision']],'正样本rec':[label2_dict['recall']],'正样本f1':[label2_dict['f1-score']],'正样本count':[label2_dict['support']],
    ...
    result_df.to_csv("./testresult/test_code_len_result.csv", encoding='gbk', index = False)